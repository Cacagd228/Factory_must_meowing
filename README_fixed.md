...
| FerriteCore | `ferritecore-7.0.3-neoforge.jar` | 7.0.3 | Память |
...
| Architectury | `architectury-13.0.11-neoforge.jar` | 13.0.11 | Либа KubeJS |
| Rhino | `
...
Транзитивно (внутри): `veil 4.3.2`, `transition 1.0.21`, `render 1.0.15`, `flywheel 1.0.6`, `ponder 1.0.82`.
